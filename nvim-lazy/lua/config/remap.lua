...
vim.keymap.set("n", "s", subst.operator, { noremap = true })
vim.keymap.set("n", "ss", subst.line, { noremap = true })
vim.keymap.set("n", "S", subst.eol, { noremap = true })
vim.keymap.set("x", "s", subst.visual, { noremap = true })
